# -*- coding: utf-8 -*-
"""OCON_Model_Analysis_(4_features_all_speakers)_NO_OUTPUTS.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XhSmTva6_vBtenXVePj4BXinme0P5aiK
...
a = 0
b = 1
x_data_minmax[:, 0] = a + ((x_data_minmax[:, 0] - x_data_minmax[:, 0].min()) / (x_data_minmax[:, 0].max() - x_data_minmax[:, 0].min())) * (b - a)
...
class binaryClassifier(nn.Module):                                                # nn.Module: base class to inherit from
    def __init__(self, n_units, act_fun, rate_in, rate_hidden, model_name):       # self + attributes (architecture hyper-parameters)
        ...
        # Input Layer
        self.layers['input'] = nn.Linear(4, n_units)                              # Key 'input' layer specification
